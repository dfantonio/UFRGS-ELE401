...
// #define PARAMS_SIZE (PARAMS * sizeof(int)) // Tamanho do buffer necessário para receber inteiros (modelo convertido)
// /* USER CODE END PD */
...
//   int decoded_ints[PARAMS];     // Array to store the decoded integers
//   char tx_buff[20] = {0};
...
//         memcpy(&decoded_ints[i], &rx_buff[i * sizeof(int)], sizeof(int));
//       }
